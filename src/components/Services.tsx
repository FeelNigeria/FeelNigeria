                  ...
                  <div className="service-content-inner d-flex align-items-center bg-white border border-success rounded p-4 pe-0">
                    <div className="service-content text-end">
                      ...
                      <p className="mb-0">
                        ...
                        designed itineraries ensure an unforgettable
                        experience..
                      </p>
                    </div>
                ...
                <div className="col-12">
                  <div className="service-content-inner d-flex align-items-center bg-white border border-success rounded p-4 pe-0">
                    <div className="service-content text-end">
                      ...
                      <p className="mb-0">
                        Our team of experienced and knowledgeable travel guides
                        is passionate about showcasing Nigeria’s hidden gems.
                        They will accompany you on your journey, offering
                        valuable insights, historical context, and local
                        anecdotes to enrich your travel experience.
                      </p>
                    </div>
                    <div className="service-icon p-4">
                  ...
                  <div className="service-content-inner d-flex align-items-center bg-white border border-success rounded p-4 ps-0">
                    ...
                    <div className="service-content">
                      ...
                      <p className="mb-0">
                        ...
                        and dance performances, or explore local art workshops
                        to gain a deeper appreciation of the country’s vibrant
                        traditions.
                      </p>
                    </div>
                  </div>
